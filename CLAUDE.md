...
- Stop inputs carry their chart line colors (green long, red short — matches the Long/Short toggle). Recalc-triggered re-renders pulse stat values (.pulse). Errors are fixed-position toasts, self-dismiss in 6s
